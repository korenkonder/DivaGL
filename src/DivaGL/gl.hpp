...
typedef struct _HPBUFFERARB* HPBUFFERARB;
typedef struct _HPVIDEODEV* HPVIDEODEV;

typedef enum AttribMask {
...
typedef enum BufferStorageMask {
...
typedef enum ClearBufferMask {
    GL_COVERAGE_BUFFER_BIT_NV    = 0x00008000,
} ClearBufferMask;

typedef enum ClientAttribMask {
    GL_CLIENT_PIXEL_STORE_BIT    = 0x00000001,
    GL_CLIENT_VERTEX_ARRAY_BIT   = 0x00000002,
    GL_CLIENT_ALL_ATTRIB_BITS    = 0xFFFFFFFF,
} ClientAttribMask;

typedef enum ContextFlagMask {
...
typedef enum ContextProfileMask {
    GL_CONTEXT_CORE_PROFILE_BIT          = 0x00000001,
    GL_CONTEXT_COMPATIBILITY_PROFILE_BIT = 0x00000002,
} ContextProfileMask;

typedef enum MapBufferAccessMask {
...
typedef enum MemoryBarrierMask {
...
typedef enum OcclusionQueryEventMaskAMD {
...
typedef enum SyncObjectMask {
    GL_SYNC_FLUSH_COMMANDS_BIT       = 0x00000001,
    GL_SYNC_FLUSH_COMMANDS_BIT_APPLE = 0x00000001,
} SyncObjectMask;

typedef enum UseProgramStageMask {
...
typedef enum SubgroupSupportedFeatures {
...
typedef enum TextureStorageMaskAMD {
    GL_TEXTURE_STORAGE_SPARSE_BIT_AMD    = 0x00000001,
} TextureStorageMaskAMD;

typedef enum FragmentShaderDestMaskATI {
    GL_RED_BIT_ATI   = 0x00000001,
    GL_GREEN_BIT_ATI = 0x00000002,
    GL_BLUE_BIT_ATI  = 0x00000004,
} FragmentShaderDestMaskATI;

typedef enum FragmentShaderDestModMaskATI {
...
typedef enum FragmentShaderColorModMaskATI {
    GL_COMP_BIT_ATI      = 0x00000002,
    GL_NEGATE_BIT_ATI    = 0x00000004,
    GL_BIAS_BIT_ATI      = 0x00000008,
} FragmentShaderColorModMaskATI;

typedef enum TraceMaskMESA {
...
typedef enum PathRenderingMaskNV {
    GL_BOLD_BIT_NV                               = 0x01,
...
typedef enum FoveationConfigBitQCOM {
...
typedef enum MapTextureFormatINTEL {
    GL_LAYOUT_DEFAULT_INTEL              = 0,
    GL_LAYOUT_LINEAR_INTEL               = 1,
    GL_LAYOUT_LINEAR_CPU_CACHED_INTEL    = 2,
} MapTextureFormatINTEL;

typedef enum PathRenderingTokenNV {
...
typedef enum TransformFeedbackTokenNV {
    GL_NEXT_BUFFER_NV        = -2,
...
typedef enum WGLColorBufferMask {
...
typedef enum WGLContextFlagsMask {
...
typedef enum WGLContextProfileMask {
...
typedef enum WGLImageBufferMaskI3D {
    WGL_IMAGE_BUFFER_MIN_ACCESS_I3D  = 0x00000001,
    WGL_IMAGE_BUFFER_LOCK_I3D        = 0x00000002,
} WGLImageBufferMaskI3D;

typedef enum WGLDXInteropMaskNV {
